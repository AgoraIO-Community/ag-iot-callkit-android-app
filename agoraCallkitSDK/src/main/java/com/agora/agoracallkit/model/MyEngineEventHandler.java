...
public class MyEngineEventHandler {
    ...
    public class CallKitEventHandler extends IRtcEngineEventHandler {
        private final String TAG = "CALLKIT/CallKitEHandler";
        ...
        public void onFirstRemoteVideoDecoded(int uid, int width, int height, int elapsed) {
            String strLog = String.format(Locale.getDefault(), "<onFirstRemoteVideoDecoded> uid=%d, width=%d, height=%d, elapsed=%d",
