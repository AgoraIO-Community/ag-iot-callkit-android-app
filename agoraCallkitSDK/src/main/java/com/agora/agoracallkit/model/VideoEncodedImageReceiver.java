...
public class VideoEncodedImageReceiver implements IVideoEncodedImageReceiver {
    private final static String TAG = "CALLKIT/VidEncImgRcver";
    ...
    public boolean OnEncodedVideoImageReceived(ByteBuffer buffer,
        ...
        String strLog = String.format(Locale.getDefault(), "<OnEncodedVideoImageReceived> remoteUid=%d, buffer.capacity=%d, info=%s",
        ...
        if (currentIndex >= com.agora.agoracallkit.model.EncodedVideoFrame.ENCODED_FRAME_TOTAL) return true;
        String baseName = baseName(com.agora.agoracallkit.model.EncodedVideoFrame.ENCODED_IMAGE_FILE_NAME);
        String extName = extName(com.agora.agoracallkit.model.EncodedVideoFrame.ENCODED_IMAGE_FILE_NAME);
